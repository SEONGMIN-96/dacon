...
x_train, x_test, y_train, y_test = train_test_split(x, y,
                train_size=0.8, shuffle=True, random_state=11)
...
es = EarlyStopping(monitor='val_loss', mode='min', patience=51)
...
start_time = time.time()
hist = model.fit(x_train, y_train, epochs=2000, batch_size=512, verbose=1, validation_split=0.2, callbacks=[es, mcp, reduce_lr])
end_time = time.time() - start_time
