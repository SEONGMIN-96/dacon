...
data = pd.read_csv('./_data/_agricultural_products01/public_data/train.csv')
...
for date in public_date_list:
    test_df = pd.read_csv(f'../_data/_agricultural_products01/public_data/test_files/test_{date}.csv')
    data = pd.read_csv('../_data/_agricultural_products01/public_data/train.csv')
    ...
    submission.to_csv('../_data/_agricultural_products01/farm_price.csv', index=False)